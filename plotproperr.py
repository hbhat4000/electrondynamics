...
ax.set_xlabel('time')
ax.set_ylabel('RMSE propagation error (compared w/ Gaussian)')
fig.tight_layout()
...
fig, ax = plt.subplots()
myms = 0.75
plt.plot(tdexHamerrWF['heh+'],'k.',ms=myms,label='HeH+ exact Ham WF')
plt.plot(tdmlHamerrWF['heh+'],'g.',ms=myms,label='HeH+ ML Ham WF')
plt.plot(tdexHamerrWF['h2'],'rs',ms=myms,label='H2 exact Ham WF')
plt.plot(tdmlHamerrWF['h2'],'ms',ms=myms,label='H2 ML Ham WF')
plt.plot(tdexHamerrWF['lih'],'bd',ms=myms,label='LiH exact Ham WF')
plt.plot(tdmlHamerrWF['lih'],'cd',ms=myms,label='LiH ML Ham WF')
ax.legend(loc='upper left',markerscale=4.0)
ax.set_xlabel('time')
ax.set_ylabel('RMSE propagation error (compared w/ Gaussian)')
fig.tight_layout()
...
ax.set_xlabel('time')
ax.set_ylabel('RMSE propagation error between ML Ham and exact Ham')
fig.tight_layout()

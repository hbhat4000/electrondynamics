...
mol = 'h2'
savepath = './'+mol+'LINEAR/'
rawden = onp.load('./td_dens_re+im_rt-tdexx_delta_s0_'+mol+'_6-31g.npz',allow_pickle=True)
overlap = onp.load('./ke+en+overlap+ee_twoe_hf_delta_s0_'+mol+'_6-31g.npz',allow_pickle=True)
